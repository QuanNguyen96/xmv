$(document).ready(function(){
	...
	if ($('#gieo_tiep').val() == 1) {
		...
		if($('#img_1').attr('data-value') == 1)
			$('#img_1').attr('src','http://trumsim.vn/tuvikhoahoc.vn/public/templates/sitev2/images/xamlinhxam/duong.png');
		
		if($('#img_1').attr('data-value') == 0)
			$('#img_1').attr('src','http://trumsim.vn/tuvikhoahoc.vn/public/templates/sitev2/images/xamlinhxam/am.png');

		if($('#img_2').attr('data-value') == 1)
			$('#img_2').attr('src','http://trumsim.vn/tuvikhoahoc.vn/public/templates/sitev2/images/xamlinhxam/duong.png');

		if($('#img_2').attr('data-value') == 0)
			$('#img_2').attr('src','http://trumsim.vn/tuvikhoahoc.vn/public/templates/sitev2/images/xamlinhxam/am.png');
	...
	$('#btn_xinque').on('click',function(){
		$('#tbl_xinkeo').removeClass('hidden');
		$.ajax({
			url: 'http://trumsim.vn/tuvikhoahoc.vn/site/tool_xamtaquan/xinxam',
			type: 'post',
	...
	$('#btn_xinkeo').on('click',function(){
		...
		$('#lan').val(lan);
		$.ajax({
			url:'http://trumsim.vn/tuvikhoahoc.vn/site/tool_xamtaquan/xinkeo',
			type: 'post',
			data :{
				solan : lan,
			},
	...
	$('#btn_noidung').click(function(){
		...
		$.ajax({
			url:'http://trumsim.vn/tuvikhoahoc.vn/site/tool_xamtaquan/xemnoidungque',
