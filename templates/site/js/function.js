...
function frm_tra_cuu_tu_vi_2021(form_name) {
...
function frm_tra_cuu_tu_vi_2022moi(form_name) {
    var form_id = '#' + form_name;
    var url = $(form_id).attr('action');
    var nam_sinh = $(form_id + ' select[name="nam_sinh"] option:selected').val();
...
/**
 * @description thêm năm sinh vào url, để bên seo đo được số lượt truy cập của người dùng từng năm.
 */
function xemBoiSoChungMinh(){
    if($("form[name='xemBoiSoChungMinh']").length>0){
        $(".myinput").change(function(){
            ngay = $("select[name='ngay']").val();
            thang = $("select[name='thang']").val();
            nam = $("select[name='txtnam']").val();
            $("form[name='xemBoiSoChungMinh']").attr('action',"/xem-boi-so-chung-minh-nhan-dan.html?ns="+ngay+'-'+thang+'-'+nam);
        })
 ...
 * @description thêm năm sinh vào url, để bên seo đo được số lượt truy cập của người dùng từng năm.
 */
function xemBoiNgaySinh(){
    if($("form[name='xemBoiNgaySinh']").length>0){
        $(".myinput").change(function(){
            ngay = $("select[name='ngay']").val();
            thang = $("select[name='thang']").val();
            nam = $("select[name='nam']").val();
            $("form[name='xemBoiNgaySinh']").attr('action',"/xem-boi-ngay-sinh.html?ns="+ngay+'-'+thang+'-'+nam);
        })
 ...
 * @description thêm năm sinh vào url, để bên seo đo được số lượt truy cập của người dùng từng năm.
 */
function boiBienSoXe(){
    if($("form[name='boiBienSoXe']").length>0){
        $("select[name='namsinh']").change(function(){
            nam = $("select[name='namsinh']").val();
            $("form[name='boiBienSoXe']").attr('action',"/xem-boi-bien-so-xe.html?ns="+nam);
        })
 ...
 * @description thêm năm sinh vào url, để bên seo đo được số lượt truy cập của người dùng từng năm.
 */
function form_boikieu(){
    if($("form[name='form_boikieu']").length>0){
        $(".myinput").change(function(){
            ngay = $("select[name='ngaysinh'] option:selected").text();
            thang = $("select[name='thangsinh'] option:selected").text();
            nam = $("select[name='namsinh'] option:selected").text();
            $("form[name='form_boikieu']").attr('action',"/xem-boi-kieu.html?ns="+ngay+'-'+thang+'-'+nam);
        })
    }
}
