            ...
            <div id="tabs-1">
                <div class="tabs_left">
                    <div class="field" id="field_slug">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo $item['name'];?>" placeholder="" />
                    </div>
                    <div class="field" id="field_slug">
                        <label>Email user</label>
                        <input type="text" name="email" id="email" value="<?php echo $item['email'];?>" placeholder="" />
                    </div>
                    <div class="field">
                        <label for="content">Content user</label>
                        <textarea name="content" id="demo" class="demo"><?php echo $item['content'];?></textarea>
                    </div>
                    <div class="field">
                        <label for="url">Url</label>
                        <input type="text" class="form_control" name="url" value="<?php echo $item['url']; ?>">
                    </div>
                </div>
            </div>
        </div>
