...
<header class="header_control">
  <label>Thêm nhóm quản trị</label>
  <ul>
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           ...
           <div class="field">
              ...
              <textarea name="link" id="demo" class="demo" rows="20" placeholder="Chú ý: pase mỗi link trên 1 dòng"><?php echo set_value('link');?></textarea>
           </div>
        </div>
