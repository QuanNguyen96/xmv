...
<header class="header_control">
  <label>Tử vi hàng ngày - Sửa ý nghĩa ngũ hành</label>
  <ul>
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field" id="field_slug">
              <label>Tên ngũ hành kết hợp</label>
              <input type="text" name="name" id="slug" value="<?php echo $item['ngu_hanh_name'];?>" placeholder="" disabled="" />
           </div>
           <div class="field">
              <label>key</label>
              <input type="text" name="ngu_hanh_key" value="<?php echo $item['ngu_hanh_key'];?>" placeholder="" disabled="" />
           </div>
           <?php for ( $i=1; $i <= 2 ; $i++ ):?>
           <div class="field">
