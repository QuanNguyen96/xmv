...
<header class="header_control">
  <label>Tử vi ngày - Ý nghĩa quẻ</label>
  <ul>
     <li><a href="<?php echo base_url('admin/tuvingay_que/add');?>" class="button">Thêm</a></li>
     <li><a href="#" class="button" onclick="submit_form('<?php echo base_url('admin/tuvingay_que/delete');?>');">Xóa</a></li>
  </ul>
</header>
<div class="fillter">
   <form name="fillter" action="" method="get"> 
     <ul>
        ...
        <li><a href="<?php echo base_url('admin/tuvingay_que/index');?>" class="button">Hủy</a></li>
     </ul>
    </form>  
  </div>
  <form name="adminForm" id="adminForm" action="" method="post">
      <table class="table">
         ...
         <tbody>
            <?php if( !empty($list) ):
                   foreach( $list as $val ):
                   $edit_link = base_url('admin/tuvingay_que/edit?id='.$val['id'].'&page='.$get['page']);
                   if($val['y_nghia'] == null)
                    $y_nghia = 'chưa có';
                   else
