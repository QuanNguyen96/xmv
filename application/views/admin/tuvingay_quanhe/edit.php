...
<header class="header_control">
  <label>Tử vi hàng ngày - Sửa quan hệ</label>
  <ul>
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field" id="field_slug">
              ...
              <input type="text" name="quan_he_name" id="slug" value="<?php echo $item['quan_he_name'];?>" placeholder="" disabled="" />
           </div>
           <div class="field">
              <label>Nhóm quan hệ</label>
              <input type="text" name="nhom_quan_he_name" value="<?php echo $item['nhom_quan_he_name'];?>" placeholder="" disabled="" />
           </div>
           <?php for ( $i=1; $i <= $item['so_y_nghia'] ; $i++ ):?>
           <div class="field">
