...
<header class="header_control">
  <label>Sửa nội dung sao phụ tinh</label>
  <ul>
     ...
     <li><a href="<?php echo base_url($this->module_view.'/'.$this->router->fetch_class().'/phutinh');?>" class="button">Đóng</a></li>
  </ul>
</header>
<div id="tabs">
        ...
        <div class="tabs_left">
           <div class="field">
              ...
              <select name="name_sao" id="" class="form_control">
              	<?php foreach ($saophu as $key => $value):
              		$slt = $value == $item['name_sao']?'selected=""':'';
              	?>
           ...
           <div class="field">
              <label>Cung</label>
              <select name="cung" id="" class="form_control">
              	<?php foreach ($cung as $key => $value):
              		$sltc = $value == $item['cung']?'selected=""':'';
              	?>
              		<option value="<?php echo $value; ?>" <?php echo $sltc; ?>><?php echo $value; ?></option>
              	<?php endforeach ?>
              </select>
           </div>
           <div class="field">
