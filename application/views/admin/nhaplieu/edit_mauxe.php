...
<header class="header_control">
  ...
  <ul>
     ...
     <li><a href="<?php echo base_url($this->module_view.'/'.$this->router->fetch_class().'/index_mauxe');?>" class="button">Đóng</a></li>
  </ul>
</header>
<div id="tabs">
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              ...
              <input type="text" name="menh_slug" value="<?php echo $item['menh_slug'];?>" placeholder="" />
           </div>
           <div class="field">
              <label>Mệnh text</label>
              <input type="text" name="menh_text" value="<?php echo $item['menh_text'];?>" />
           </div>
           <div class="field">
