...
<header class="header_control">
  <label>Thêm nội dung bói kiều</label>
  <ul>
...
<div id="tabs">
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              <label>Số câu</label>
              <input type="text" name="socau" value="" placeholder="" />
           </div>
           <div class="field">
              <label>Nội dung</label>
              <textarea name="noidung" id="demo" class="demo"></textarea>
           </div>
           <div class="field">
              <label>Điều Hướng</label>
              <textarea name="dieu_huong" id="demo1" class="demo"></textarea>
           </div>
        </div>
