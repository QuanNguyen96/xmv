...
<header class="header_control">
  <label>Quản lý nội dung sao chính tinh</label>
  <ul>
     <li><a href="<?php echo base_url('admin/nhaplieu/add_chinhtinh');?>" class="button">Thêm</a></li>
     <li><a href="#" class="button" onclick="submit_form('<?php echo base_url('admin/nhaplieu/delete_chinhtinh');?>');">Xóa</a></li>
  </ul>
</header>
<div class="fillter">
   <form name="fillter" action="" method="get"> 
     <ul>
        ...
        <li><a href="<?php echo base_url('admin/nhaplieu/chinhtinh');?>" class="button">Hủy</a></li>
     </ul>
    </form>  
  </div>
  <form name="adminForm" id="adminForm" action="" method="post">
      <table class="table">
         ...
         <tbody>
            <?php if( !empty($list) ):
                   foreach( $list as $val ):
                   $edit_link = base_url('admin/nhaplieu/edit_chinhtinh?id='.$val['id'].'&page='.$get['page']);
            ?>
             <tr>
                ...
                <td><?php echo $vitri[$val['position']]; ?></td>
