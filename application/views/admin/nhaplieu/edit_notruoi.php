...
<header class="header_control">
  ...
  <ul>
     ...
     <li><a href="<?php echo base_url($this->module_view.'/'.$this->router->fetch_class().'/index_notruoi');?>" class="button">Đóng</a></li>
  </ul>
</header>
<div id="tabs">
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              ...
              <input type="text" name="position_text" value="<?php echo $item['position_text'];?>" placeholder="" />
           </div>
           <div class="field">
              <label>Vị trí slug</label>
              <input type="text" name="position_slug" value="<?php echo $item['position_slug'];?>" />
           </div>
           <div class="field">
              <label>Nội dung</label>
              <textarea name="content" id="demo" class=""><?php echo $item['content'];?></textarea>
           </div>
        </div>
