...
<header class="header_control">
  <label>Sửa nội dung bói chỉ tay</label>
  <ul>
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              ...
              <input type="text" name="name_text" value="<?php echo $item['name_text'];?>" placeholder="" />
           </div>
           <div class="field">
              <label>Slug chỉ tay</label>
              <input type="text" name="name_slug" value="<?php echo $item['name_slug'];?>" />
           </div>
           <div class="field">
              <label>Nội dung</label>
              <textarea name="content_chitay" id="demo" class=""><?php echo $item['content_chitay'];?></textarea>
           </div>
        </div>
