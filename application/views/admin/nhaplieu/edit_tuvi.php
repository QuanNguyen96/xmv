...
<header class="header_control">
  <label>Sửa nội dung tử vi trọn đời</label>
  <ul>
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              ...
              <input type="text" name="namsinh" value="<?php echo $item['namsinh'];?>" placeholder="" />
           </div>
           <div class="field">
              <label>Can chi slug</label>
              <input type="text" name="canchi_slug" value="<?php echo $item['canchi_slug'];?>" />
           </div>
           <div class="field">
              <label>Nội dung nam</label>
              <textarea name="content_nam" id="demo" class=""><?php echo $item['content_nam'];?></textarea>
           </div>
           <div class="field">
              <label>Nội dung nữ</label>
              <textarea name="content_nu" id="demo1" class=""><?php echo $item['content_nu'];?></textarea>
           </div>
        </div>
