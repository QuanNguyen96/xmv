...
<header class="header_control">
  <label>Sửa Màu xe hợp mệnh</label>
  <ul>
     ...
     <li><a href="<?php echo base_url($this->module_view.'/'.$this->router->fetch_class().'/index_boikieu');?>" class="button">Đóng</a></li>
  </ul>
</header>
<div id="tabs">
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              <label>Số câu</label>
              <input type="text" name="socau" value="<?php echo $item['socau'];?>" placeholder="" />
           </div>
           <div class="field">
              <label>Nội dung</label>
              <textarea name="noidung" id="demo" class=""><?php echo $item['noidung'];?></textarea>
           </div>
           <div class="field">
              <label>Điều Hướng</label>
              <textarea name="dieu_huong" id="demo1" class=""><?php echo $item['dieu_huong'];?></textarea>
           </div>
        </div>
