...
<header class="header_control">
  <label>Thêm nội dung màu xe hợp mệnh</label>
  <ul>
...
<div id="tabs">
      ...
      <div id="tabs-1">
        <div class="tabs_left">
           <div class="field">
              <label>Mệnh slug</label>
              <input type="text" name="menh_slug" value="" placeholder="" />
           </div>
           <div class="field">
              <label>Mệnh text</label>
              <input type="text" name="menh_text" value="" placeholder="" />
           </div>
           <div class="field">
              <label>Nội dung</label>
              <textarea name="content" id="demo" class="demo"></textarea>
           </div>
        </div>
