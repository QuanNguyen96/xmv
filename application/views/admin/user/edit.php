      ...
      <div id="tabs-1">
        <div class="tabs_left">
           ...
           <div class="field" id="field_title">
            ...
            <div class="field" id="field_title">
                <label>Intro</label>
                <textarea name="intro"><?php echo $item['intro'];?></textarea>
            </div>
           <div class="field" id="field_title">
           ...
           <div class="field" id="field_title">
              ...
              <input type="radio" name="edit_delete" value="0" <?php if( $item['manage'] == 0 ) echo 'checked=""'; ?> /> <span>Không</span> &nbsp;&nbsp;&nbsp;
              <input type="radio" name="edit_delete" value="1" <?php if( $item['manage'] == 1 ) echo 'checked=""'; ?> /> <span>Có</span>
           </div>
           <?php endif; ?>
           <div class="field" id="field_title">
              ...
              <?php if( !empty( $manage ) ): ?>
               <ul class="nqt">
                 <?php foreach( $manage as $val ): 
                         $ck = in_array( $val['id'], $curent_manage ) ? 'checked=""' : '';
                 ?>
                    <li><input type="checkbox" name="manage[]" value="<?php echo $val['id'];?>" <?php echo $ck; ?> /><span><?php echo $val['name'];?></span></li>
                 <?php endforeach; ?>
               </ul>
              <?php endif; ?>
           </div>
