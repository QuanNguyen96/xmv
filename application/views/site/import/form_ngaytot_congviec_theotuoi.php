<?php if ($this->mobile_detect->isMobile()): ?>
	<div class="boxFormXemNgay inner_box_red box_cuoihoi_fix">
		...
		<form class="form_vien" name="ngaytot_congviec_tuoicanchi" method="post" onsubmit="submit_formXemngay_congviec_theotuoi();">
            <div class="txt_1xnt">
...
<?php endif ?>
<script>
	function submit_formXemngay_congviec_theotuoi() {
		var frm    = document.ngaytot_congviec_tuoicanchi;
		var canchi = frm.nam_sinh.value;
     	var link   = 'xem-ngay-tot-' + '<?php echo $data_date['slug'] ?>' + '-tuoi-' + canchi + '.html';
