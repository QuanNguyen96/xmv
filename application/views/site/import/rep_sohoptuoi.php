<div class="box_xvm my_khung">
	...
	<form name="rep_sohoptuoi" style="margin:20px 0" method="post" action="" onsubmit="rep_sohoptuoi_submit();return false;">
		<div class="row">
		...
		<script>
			function rep_sohoptuoi_submit(){
				var frm = document.rep_sohoptuoi;
