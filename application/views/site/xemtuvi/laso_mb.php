<link rel="stylesheet" href="<?php echo base_url('templates/site/laso/laso_html.css?v=0.1'); ?>" />
...
<div class="box_content box_xvm box_ngaytotxau clearfix" style="border: none;">
    ...
    <form name="" action="<?php echo base_url('xem-la-so-tu-vi.html'); ?>" method="post" id="boxFormLaso">
        <div class="field">
        ...
        <div class="field">
            ...
            <div class="col-md-2 col-sm-2 col-xs-4">
                <select name="namxem" required="">
                    ...
                    <?php 
                        for( $i = 2015; $i<= 2040; $i++ ){
                            echo '<option value="'.$i.'" '.set_select('namxem', $i).'>'.$i.'</option>';
                        }
                        ?>
                </select>
            </div>
    ...
    <div class="field">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (isset($success)): ?>
                    <script>
                        ...
                        $(document).ready(function(){
                            scrollTo('#boxFormLaso');
                        });
                    </script>
                    <p class="text-center"><a id="btn-Convert-Html2Image">Lưu lá số</a></p>
                <?php endif ?>
                <br/>
                <div id="previewImage">
                </div>
                ...
                <script>
                    $(document).ready(function(){
                        var element = $("#lasotuvi"); // global variable
                        ...
                        $("#btn-Convert-Html2Image").on('click', function () {
                            ...
                            var imgageData = $('#img_laso').attr('src');

                            // Now browser starts downloading it instead of just showing it
                            var newData = imgageData.replace(/^data:image\/png/, "data:application/octet-stream");

                            $("#btn-Convert-Html2Image").attr("download", "lasotuvi.png").attr("href", newData);
                        });
                        // $('.lasotuvi').hide();
            ...
            <div class="col-md-12">
                <?php if (isset($success)): ?>
                    <section class="lasoTuviWrap">
                        ...
                        <?php endif ?>
                        <?php if ($quedichtheonamsinh): ?>
                            <div class="listBoxLaso">
                                <p class="title_l"><label>Quẻ dịch theo năm sinh</label></p>
                                <div class="boxContentMini">
                                    <section class="contentMini">
                                        <?php echo $quedichtheonamsinh['noidung']; ?>
                                    </section>
                                    <p class="viewShow viewmore" data-view="on"><span>Xem thêm bài luận</span><br><label class="imageButton"></label></p>
                                </div>
                            </div>
                        ...
                        <?php endif ?>
                        <?php if ($contentThanCu): ?>
                            <div class="listBoxLaso">
                                <p class="title_l"><label><?php echo 'Thân cư '.$nameThanCu; ?></label></p>
                                <div class="boxContentMini">
                                    <section class="contentMini">
                                        <?php echo $contentThanCu?$contentThanCu['content']:''; ?>
                                    </section>
                                    <p class="viewShow viewmore" data-view="on"><span>Xem thêm bài luận</span><br><label class="imageButton"></label></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <?php if ($get_content_sao_detail): ?>
                                    <?php foreach ($get_content_sao_detail as $value): ?>
                                        <div class="col-md-6">
                                            <div class="boxYnghiaSao">
                                                <p class="title_icon title_icontron viewbox" data-view="<?php echo $hookPosition; ?>"><?php _e('Cung '.$value['name_cung_chi']); ?> <label>Xem chi tiết</label></p>
                                                <section class="content">
                                                                ...
                                                                for ($j = $firstAge; $j <= $endAge ; $j++) {
                                                                    ...
                                                                    <?php if (isset($han_tuoi_trong_cung[$j])): ?>
                                                                        <div class="col-md-6 col-xs-6 col-sm-6">
                                                                            <p class="title_box_vh_age" data-view="<?php echo $hookPosition; ?>"><?php echo $j ?> tuổi - <?php echo $han_tuoi_trong_cung[$j]['year'] ?> <span class="title_icon_vh"></span></p>
                                                                            <div class="content">
...
<!-- Modal -->
<button class="clickHere" data-toggle="modal" data-target="#myModal" data-seen="0" style="display: none;">Click here</button>
