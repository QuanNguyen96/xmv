...
<div class=" clearfix col-md-12">
                ...
                <div class="menu_text_2">
                    <div class="content_link_text">
                       <div class="link_text_1">
                        ...
                        ?>
                        <div>
                          <a href="<?php echo '#tuoi_'.$value['slug'];?>"><?php echo $i;?>. Tử vi ngày <?php echo $ngay_xem;?> tuổi <?php echo $value['name'];?></a>
                        </div>
                        <?php endforeach ?>
                       </div>
                    </div>
    ...
    <div class="tvhn_content">
       <?php foreach ($list_tuoi as $key => $value): 
              $heading_tuoi = 'tử vi ngày '.$ngay_xem.' '.$value['name'];
       ?>
         <div class="" id="<?php echo 'tuoi_'.$arr_hoa_giap[$key]['slug'];?>">
           <div class="tvhn_content_heading"><?php echo $heading_tuoi;?></div>
           <ul class="tv_theo_tuoi_ul tv_cl_black">
             <?php 
             foreach ($value['list'] as $key1 => $value1): 
                $tuoi_chi_tiet_text = $que_y_nghia[$value1['number']];
                $tuoi_chi_tiet_link = 'tu-vi-hang-ngay/tu-vi-tuoi-'.$arr_hoa_giap[$key]['slug'].'-ngay-hom-nay-'.str_replace('/','-',$ngay_xem).'.html';
             ?>
               <li><b><?php echo $value1['text'];?></b><?php echo $tuoi_chi_tiet_text;?><a class="tvn_view_more" href="<?php echo base_url($tuoi_chi_tiet_link);?>">Xem chi tiết</a></li>
             <?php endforeach ?>
           </ul>
         </div>
       <?php endforeach ?>
            ...
            <div class="col-md-5">
               ...
               <ul class="tvn_sub_list">
                   <?php foreach ($list_5_ngay_tiep as $key => $value):
                            $link_tiep = 'tu-vi-hang-ngay/tu-vi-ngay-'.$value['ngay_duong'].'-thang-'.$value['thang_duong'].'-nam-'.$value['nam_duong'].'.html';
                   ?>
                    <li><a href="<?php echo base_url($link_tiep);?>"><?php echo 'Xem tử vi ngày '.$value['ngay_duong'].' tháng '.$value['thang_duong'].' năm '.$value['nam_duong'];?></a></li>
                   <?php endforeach; ?> 
               </ul>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-5">
               ...
               <ul class="tvn_sub_list">
                   <?php foreach ($list_5_ngay_truoc as $key => $value):
                          $link_truoc = 'tu-vi-hang-ngay/tu-vi-ngay-'.$value['ngay_duong'].'-thang-'.$value['thang_duong'].'-nam-'.$value['nam_duong'].'.html';
                   ?>
                    <li><a href="<?php echo base_url($link_truoc);?>"><?php echo 'Xem tử vi ngày '.$value['ngay_duong'].' tháng '.$value['thang_duong'].' năm '.$value['nam_duong'];?></a></li>
                   <?php endforeach; ?> 
               </ul>
            </div>
        </div>
