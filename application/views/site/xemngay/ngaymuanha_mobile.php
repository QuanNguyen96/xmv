...
<div class="box_xvm box_ngaytotxau">
    ...
    <section class="box-form inner_box_red">
        ...
        <div class="boxThree">
            <form name="xemngay_theotuoi_muanha" method="post" onsubmit="xemngay_theotuoi_muanha_submit();">
                <div class="row">
                    <div class="col-xs-12">
                ...
                <script>
                    function xemngay_theotuoi_muanha_submit(){
                        var frm    = document.xemngay_theotuoi_muanha;
                        var canchi = frm.nam_sinh.value;
                        var link   = 'xem-ngay-tot-mua-nha-tuoi-' + canchi + '.html';
	...
	<div class="field">
		<div class="col-md-12">
			<section class="result" id="result">
				...
				<section class="field list_thang_tot_mb">
