<?php
$cr_date = isset($duonglich) ? $duonglich[0].'/'.$duonglich[1].'/'.$duonglich[2] : date('j').'/'.date('n').'/'.date('Y');
?>
...
<div class="box_content box_xvm box_ngaytotxau">
    ...
    <div class="desktop_padding">
        ...
        <section class="boxFormXemNgay inner_box_red">
                        ...
                        <div class="col-md-6 col-xm-6 col-xs-12">
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" name="" value="<?php echo $cr_date; ?>" id="datepicker" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="boxThree">
                <form name="xemngay_theotuoi_muaxe" method="post" onsubmit="xemngay_theotuoi_muaxe_submit();">
                    <div class="row">
                        <div class="col-md-3 col-xm-3 col-xs-12">
                    ...
                    <script>
                        function xemngay_theotuoi_muaxe_submit(){
                            var frm    = document.xemngay_theotuoi_muaxe;
                            var canchi = frm.nam_sinh.value;
                            var link   = 'xem-ngay-tot-mua-xe-tuoi-' + canchi + '.html';
            ...
            <div class="result_table">
              <table class="table table-hover table-bordered table-responsive table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><label><a href="<?php echo base_url('tinh-ngay-tot-theo-khong-minh-luc-dieu-A1322.html'); ?>" title="">Khổng Minh Lục Diệu</a></label></td>
                    <td>
                      <?php if (!empty($result_tinh_khongminh)): ?>
                      <?php if (!empty($result_tinh_khongminh['tinh_khongminh'])): ?>
                        <p>Ngày : <strong><?php echo add_link_khong_minh($result_tinh_khongminh['tinh_khongminh'][2]['name'])?></strong></p>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p><?php echo replace_tinhtrucngay($result_nguhanh_huongdi['seo_ketluan'],array('thang'=>$duonglich[1],'nam'=>$duonglich[2])) ?></p>
