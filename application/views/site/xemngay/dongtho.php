...
<div class="box_content box_xvm box_ngaytotxau">
    ...
    <div class="desktop_padding">
        ...
        <section class="boxFormXemNgay inner_box_red">
            ...
            <div class="boxThree">
                <form name="xemngay_theotuoi_dongtho" method="post" onsubmit="xemngay_theotuoi_dongtho_submit();">
                    <div class="row">
                        <div class="col-md-3 col-xm-3 col-xs-12">
                    ...
                    <script>
                    function xemngay_theotuoi_dongtho_submit(){
                    var frm    = document.xemngay_theotuoi_dongtho;
                    var canchi = frm.nam_sinh.value;
                    var link   = 'xem-ngay-tot-dong-tho-tuoi-' + canchi + '.html';
                ...
                <div class="result_table">
                    <table class="table table-hover table-bordered table-responsive table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <label class="color_red"><a href="<?php echo base_url('xem-ngay-tot-hoang-dao.html'); ?>">Giờ Hoàng Đạo</a></label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td><label class="color_black">Giờ Hắc Đạo</label></td>
                                <td>
                            ...
                            <tr>
                                <td><label class="">Các Ngày Kỵ</label></td>
                                <td>
                            ...
                            <tr>
                                <td><label><a href="<?php echo base_url('nhi-thap-bat-tu-la-gi-A1342.html'); ?>">Nhị Thập Bát Tú</a> <span class="color_red">(<?php echo $result_tinhthapnhibattu[1] ?>)</span></label></td>
                                <td>
                                    <div>
