...
<section>
	...
	<div class="box-mobile">
		...
		<div class="box-btbkn">
			<div class="title-xemngay"><span><a href="<?php echo base_url('chon-ngay-tot-theo-banh-to-bach-ky-nhat-A1344.html'); ?>" title="">Bành Tổ Bách Kị Nhật</a></span></div>
			<div class="text-center">
		...
		<div class="box-kmld">
			<div class="title-xemngay"><span><a href="<?php echo base_url('tinh-ngay-tot-theo-khong-minh-luc-dieu-A1322.html'); ?>" title="">Khổng Minh Lục Diệu</a></span></div>
			<div class="text-center">
				<?php if (!empty($result_tinh_khongminh)): ?>
                    <?php if (!empty($result_tinh_khongminh['tinh_khongminh'])): ?>
						<p style="font-weight: bold;">
							Ngày : <strong class="<?php echo $result_tinh_khongminh['tinh_khongminh'][2]['saotot']==1?'color_red':'color_black'; ?>"><?php echo add_link_khong_minh($result_tinh_khongminh['tinh_khongminh'][2]['name'])?></strong>
						</p>
		...
		<div class="box-ntbt">
			<div class="title-xemngay"><span><a href="<?php echo base_url('nhi-thap-bat-tu-la-gi-A1342.html'); ?>">Nhị Thập Bát Tú</a> : Sao <?php echo $result_tinhthapnhibattu[1] ?></span></div>
		...
		<div class="box-tnkt">
			<div class="title-xemngay"><span><a href="<?php echo base_url('thap-nhi-kien-tru-la-gi-A1329.html'); ?>">Thập Nhị Kiến Trừ</a> : <?php echo add_link_thap_nhi_kien_tru($result_tinhtrucngay['ten']);?></span></div>
			<div class="text-justify">
		...
		<div class="box-nhtt">
			<div class="title-xemngay"><span><a href="<?php echo base_url('ngoc-hap-thong-thu-la-gi-A1343.html');?>">Ngọc Hạp Thông Thư</a></span></div>
			<div class="text-center">
		...
		<div class="field">
            <div class="js_Form_content">
              <div class="js_content_height"><?php echo $this->my_seolink->get_text_foot(); ?></div>
            </div>
        </div>
