...
<div class="box-mobile box_xvm">
    ...
    <section class="box-form inner_box_red">
        ...
        <div class="boxThree">
            <form name="xemngay_theotuoi_xuathanh" method="post" onsubmit="xemngay_theotuoi_xuathanh_submit();">
                <div class="row">
                    <div class="col-xs-12">
                ...
                <script>
                    function xemngay_theotuoi_xuathanh_submit(){
                        var frm    = document.xemngay_theotuoi_xuathanh;
                        var canchi = frm.nam_sinh.value;
                        var link   = 'xem-ngay-tot-xuat-hanh-tuoi-' + canchi + '.html';
