...
<div class="box_content box_xvm box_ngaytotxau">
    ...
    <div class="desktop_padding">
        ...
        <section class="boxFormXemNgay inner_box_red">
            ...
            <div class="boxThree">
                <form name="xemngay_theotuoi_nhaptrach" method="post" onsubmit="xemngay_theotuoi_nhaptrach_submit();">
                    <div class="row">
                        <div class="col-md-3 col-xm-3 col-xs-12">
                    ...
                    <script>
                    function xemngay_theotuoi_nhaptrach_submit(){
                    var frm    = document.xemngay_theotuoi_nhaptrach;
                    var canchi = frm.nam_sinh.value;
                    var link   = 'xem-ngay-tot-nhap-trach-tuoi-' + canchi + '.html';
                ...
                <div class="result_table">
                    <table class="table table-hover table-bordered table-responsive table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><label>Hướng nhập trạch</label></td>
                                <td>
