		...
		<div class="box_content box_xvm box_ngaytotxau">
			...
			<?php if (isset($success) && $success == 1): ?>
			    ...
			    <?php
			        ...
			        $slug_link_thang   = $data_date['slug'] == 'nhap-trach' ? 'nhap-trach-nha-moi' : $data_date['slug'];
			        ...
			        <div class="row">
			            <div class="col-md-12">
			                <p class="text-left">
			                	...
			                	<a href="<?php echo base_url('xem-ngay-tot-'.$slug_link_thang.'-trong-thang-'.$month_show_next_1.'-nam-'.$year_show_next_1) ?>.html">
			                		<label>Xem ngày tốt <?php echo $data_date['name'] ?> tháng <?php echo $month_show_next_1; ?> năm <?php echo $year_show_next_1; ?></label>
			                	</a>
			                </p>
			            </div>
			             <div class="col-md-12">
			                <p class="text-left">
			                	<span class="muiten_link"></span>
			                	<a href="<?php echo base_url('xem-ngay-tot-'.$slug_link_thang.'-trong-thang-'.$month_show_next_2.'-nam-'.$year_show_next_2) ?>.html">
			                		<label>Xem ngày tốt <?php echo $data_date['name'] ?> tháng <?php echo $month_show_next_2; ?> năm <?php echo $year_show_next_2; ?></label>
			                	</a>
			                </p>
			            </div>
			        </div>
					...
					<div class=" field desktop_padding">
						<div class="bg_vienvang_longden">
							...
							<p style="text-align: center!important;font-weight: bold;">
								Tháng <?php echo $thang_xem ?> năm <?php echo $nam_xem ?> không có ngày tốt <?php echo $data_date['name'] ?> hợp tuổi <?php echo $canchitext ?>
							</p>
							<div>
								<i style="font-family: Arial">Qúy bạn vui lòng chọn tháng khác để xem ngày tốt <?php echo $data_date['name'] ?> hợp tuổi <?php echo $canchitext ?></i>
							</div>
						</div>
					</div>
				<?php endif ?>
            ...
            <div class="field">
            	<div class="notification_tuvi_2020">
				  <ul>
					<li><a href="<?php echo $dieu_huong_tv_2020_link_nam; ?>"><?php echo $dieu_huong_tv_2020_text_nam; ?></a></li>
					<li><a href="<?php echo $dieu_huong_tv_2020_link_nu; ?>"><?php echo $dieu_huong_tv_2020_text_nu; ?></a></li>
                  <li><a href="<?php echo $dieu_huong_tv_2022_link_nam; ?>"><?php echo $dieu_huong_tv_2022_text_nam; ?></a></li>
                  <li><a href="<?php echo $dieu_huong_tv_2022_link_nu; ?>"><?php echo $dieu_huong_tv_2022_text_nu; ?></a></li>
				  </ul>
				</div>
            </div>
			<div class="field desktop_padding">
				<div class="row">
					<div class="col-md-12">
						<div class="bg_vienvang_full">
							<div class="txt_1">
								Xem ngày tốt hợp tuổi <?php echo isset($canchitext) ? $canchitext : ''; ?> cho công việc khác
							</div>
