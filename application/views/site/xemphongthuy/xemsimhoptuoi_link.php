...
<section class="four-tool">
	<h1 class="title_l1"><?php echo $name; ?></h1>
	
	<?php if (isset($text) && $text != null): ?> 
		<div class="txt_top_bot">
			<?php echo str_replace($arr_search,$arr_replace, $text); ?>
		</div>
	<?php endif ?>

	<?php if (isset($article['content']) && $article['content'] != null): ?>
		<div class="txt_top_bot">
			<?php echo str_replace($arr_search,$arr_replace, $article['content']); ?>
		</div>
	<?php endif ?>
	
	<?php if(isset($submit)): ?>
		<div class="bg_hoavando">
			<p><span class="hidden-xs">Kết quả xem số điện thoại</span> <?php echo $sosim; ?> <span class="hidden-xs"> có</span> hợp tuổi không</p>
		</div>
	...
	<section class="bot_4cc">
		<div class="div_img">
			<a href="<?php echo base_url('xem-boi-so-dien-thoai.html'); ?>">
				<img style="width: 120px" src="<?php echo base_url(); ?>templates/site/images/4ccxemPTS/trangaytaiday.gif" alt="anh tra ngay tai day" />
			</a>
		</div>
	...
	<?php if (isset($text_foot) && $text_foot != null): ?>
		<div class="txt_top_bot">
			<?php echo str_replace($arr_search,$arr_replace, $text_foot); ?>
		</div>
	<?php endif ?>
