...
<div class="col-md-12 content_body">
    	<div class="content_mucluc">
    		...
    		<div class="muc_luc tbale_mucluc" id="click_menu_2" onclick="clickmenu2('click_menu_2');">
    			...
    			<div class="menu_text_1">
                  <div class="text_1">
                  	<a href="#bangtratv2020">I. BẢNG TRA CỨU TỬ VI 2022</a>
                  </div>
    			</div>
    			<div class="menu_text_2">
    				<div class="text_1">
    				   <a href="#bangtratv202012cg">II. BẢNG TỬ VI 2022 CỦA 12 CON GIÁP</a>
    				</div>
        ...
        <?php echo  $this->load->view('site/import/form_tv_2022', '', true); ?>

        <div class="content_table_tuvi bangtuvi2022" id="bangtratv202012cg">
        	<h2 class="text_shadow">
        		Bảng tử vi năm 2022 của 12 con giáp
        	</h2>
        	...
        	<div class="khoi_table_tuvi" id="<?php echo $id_neo;?>">
        		<div class="img_congiap">
        			...
        			<p class="text_tuoi text_tuoi_hide"><?php echo $title;?></p>
        		</div>
