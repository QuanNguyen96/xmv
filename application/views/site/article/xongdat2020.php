...
<div class="col-md-12 content_body">
    	<div class="content_mucluc">
    		...
    		<div class="muc_luc tbale_mucluc" id="click_menu_2" onclick="clickmenu2('click_menu_2');">
    			...
    			<div class="menu_text_1">
                  <div class="text_1">
                  	<a href="#bangtratv2020">I. BẢNG TRA XÔNG ĐẤT 2020</a>
                  </div>
    			</div>
    			<div class="menu_text_2">
    				<div class="text_1">
    				   <a href="#bangtratv202012cg">II. BẢNG XÔNG ĐẤT NĂM 2020 CỦA 12 CON GIÁP</a>
    				</div>
    				<div class="content_link_text">
    				   <div class="link_text_1">
    					<div>
    					  <a href="#congiap_1">1. Xem giờ xông đất tuổi Tý</a>
    				    </div>
    				    <div>
                          <a href="#congiap_2">2. Xem giờ xông đất tuổi Sửu</a>
                        </div>
    				    <div>
                          <a href="#congiap_3">3. Xem giờ xông đất tuổi Dần</a>
                        </div>
    				    <div>
                          <a href="#congiap_4">4. Xem giờ xông đất tuổi Mão</a>
                        </div>
    				    <div>
                          <a href="#congiap_5">5. Xem giờ xông đất tuổi Thìn</a>
                        </div>
                        <div>
                          <a href="#congiap_6">6. Xem giờ xông đất tuổi Tỵ</a>
                        </div>
    				   </div>
    				   <div class="link_text_2">
    					<div>
                          <a href="#congiap_7">7. Xem giờ xông đất tuổi Ngọ</a>
                        </div>
    				    <div>
                          <a href="#congiap_8">8. Xem giờ xông đất tuổi Mùi</a>
                        </div>
    				    <div>
                          <a href="#congiap_9">9. Xem giờ xông đất tuổi Thân</a>
                        </div>
    				    <div>
                          <a href="#congiap_10">10. Xem giờ xông đất tuổi Dậu</a>
                        </div>
    				    <div>
                          <a href="#congiap_11">11. Xem giờ xông đất tuổi Tuất</a>
                        </div>
                        <div>
                          <a href="#congiap_12">12. Xem giờ xông đất tuổi Hợi</a>
                        </div>
    				   </div>
    				</div>
    			</div>
        ...
        <div class="tool_tuvi" id="bangtratv2020">
        	<div class="tool_text_1">
        		TRA CỨU XÔNG ĐẤT 2020
        	</div>
        	<div class="tool_text_2">
        		Bạn vui lòng nhập chính xác thông tin của mình!
        	</div>
        	<form name="frm_tv" id="frm_tv" action="<?php echo base_url('site/article/ajax_bai_viet_xong_dat'); ?>" method="post" class="form_tool" onsubmit="frm_tra_cuu_xong_dat('frm_tv'); return false;">
        			...
        			<table class="table_tuvi">
        				<thead>
        					<tr>
        						...
        						<th class="th_text">Tuổi xông đất năm 2020</th>
        					</tr>
        				</thead>
                        <tbody>
