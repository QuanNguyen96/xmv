...
<div class="col-md-12 content_body">
    	<div class="content_mucluc">
    		...
    		<div class="muc_luc tbale_mucluc" id="click_menu_2" onclick="clickmenu2('click_menu_2');">
    			...
    			<div class="menu_text_1">
                  <div class="text_1">
                  	<a href="#bangtratv2020">I. BẢNG TRA CỨU TỬ VI 2021</a>
                  </div>
    			</div>
    			<div class="menu_text_2">
    				<div class="text_1">
    				   <a href="#bangtratv202012cg">II. BẢNG TỬ VI 2021 CỦA 12 CON GIÁP</a>
    				</div>
        ...
        <div class="tra_cuu">
            <div class="background_tra_cuu_2">
                ...
                <p class="tra_cuu_2021">TRA CỨU TỬ VI 2021</p>
                    <p class="vui_long">Bạn vui lòng nhập chính xác thông tin của mình!</p>
                    <form name="frm_tv" id="frm_tv" action="<?php echo base_url('site/article/ajax_bai_viet_tu_vi'); ?>" method="post" class="form_tool" onsubmit="frm_tra_cuu_tu_vi_2021('frm_tv'); return false;">
                        <div class="row">
                            <div class="col-md-8">
        ...
        <div class="content_table_tuvi bangtuvi2021" id="bangtratv202012cg">
        	<h2 class="text_shadow">
        		Bảng tử vi năm 2021 của 12 con giáp
        	</h2>
